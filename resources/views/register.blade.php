    ...
    <div class="flex items-center justify-center bg-white p-6 rounded-md shadow-md grow">
        ...
        <div class="w-full max-w-md bg-white p-4 rounded-xl shadow-2xl">
            ...
            <form method="POST" action="{{ route('register.attempt') }}" class="space-y-6">
                ...
                <div class="my-6">
                    <label for="fullName" class="block text-sm font-medium text-gray-700 mb-1">Pilnas vardas</label>
                    <input id="fullName" name="fullName" type="fullName" required autocomplete="fullName"
                ...
                <div class="my-6">
                    <label for="phoneNumber" class="block text-sm font-medium text-gray-700 mb-1">Telefono nr.</label>
                    <input id="phoneNumber" name="phoneNumber" type="phoneNumber" required autocomplete="fullname"
